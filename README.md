...
You can set your device directly by pasting the packets (in the good order) to your midiout object. This device goal is to show you the SysEx packets needed if you want to create your own Max device in order to configure your MF Twister.
